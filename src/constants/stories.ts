...
export const stories: Story[] = [
  {
    badgeImageUrl:
      'https://t1.kakaocdn.net/kakaocorp/kakaocorp/admin/category/dd2b88f5018800001.png?type=thumb&opt=C72x72.fwebp',
    badgeText: '임팩트',
    title: '왕초보 사장님들의\n단골 만들기 비법',
  ...
  {
    badgeImageUrl:
      'https://t1.kakaocdn.net/kakaocorp/kakaocorp/admin/category/b44c8bc2018c00001.png?type=thumb&opt=C72x72.fwebp',
    badgeText: '더 가깝게',
    title: '무료로 여는\n톡 안의 두 번째 매장',
    imageUrl:
  ...
  {
    badgeImageUrl:
      'https://t1.kakaocdn.net/kakaocorp/kakaocorp/admin/6562b710017800001.png?type=thumb&opt=C72x72.fwebp',
    badgeText: '뚝딱뚝딱 성장기',
    title: '지역 정보 매체에서\n위치 기반 상호작용 플랫폼으로',
    imageUrl:
  ...
  {
    badgeImageUrl:
      'https://t1.kakaocdn.net/kakaocorp/kakaocorp/admin/category/dd2b575f018800001.png?type=thumb&opt=C72x72.fwebp',
    badgeText: '서비스',
    title: '100명에게\n물어봤습니다',
    imageUrl:
